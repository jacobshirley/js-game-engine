...
class Ball {
  constructor(props) {
    ...
    let color = props.color || 0; //3d rendering
    ...
    let body = new Ammo.btRigidBody(rbInfo); //body.setDamping(0, 0.2);

    body.setActivationState(4); //body.setFriction(0.6);

...
var Dominos = function (_LockstepGame) {
    ...
    _createClass(Dominos, [{
        ...
        value: function getDebugString() {
            return _get(Dominos.prototype.__proto__ || Object.getPrototypeOf(Dominos.prototype), "getDebugString", this).call(this) + "<br />" + "Picker updates: " + this.ph.us;
        }
    }, {
        key: "init",
        value: function init() {
            ...
            if (!this.config.headless) {
                var mouse = new _mouse2.default(0, false);
                this.controllers.add(mouse);
                this.picker = new _picker2.default(this.renderer, this.physics, mouse, this.multiplayer.getLocalClient());
            }
